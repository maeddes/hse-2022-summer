...
== (03/28) Module: Spring Boot and - API Intro
...
== (04/03) Module: Spring Boot Recap and -

image::pics/rest_api_simple.png[- API concepts]
...
* CRUD Operations
* Building a - API with Spring (Boot)
...
== (04/11) Module: - Recap, Persistence and UI

* Repeat - API concepts & HTTP status codes
* Spring Data
...
== (05/02) Alternatives to - Guest lecturer Lars
...
=== Objectives and exercises
_The student understands there are more communication options between two peers than only - which we have covered before. It's not necessary to know implementation details, but at least awareness of their existence._
